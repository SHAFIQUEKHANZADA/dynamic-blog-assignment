...
export default async function BusinessPage() {
  const query = `*[_type == "technology-and-innovation"] {
    title,
    overview,
    slug,
    mainImage {
  ...
  const articles: TechandInnovation[] = await client.fetch(query);
      ...
      <div className="container sm:px-0 px-5 py-12 mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="-my-8 divide-y-2 divide-gray-100">
            {articles.map((article) => (
              <Link
                ...
                href={`/technology-and-innovation/${article.slug.current}`}
                passHref
        ...
        <div className="sticky top-16 sm:h-screen p-4 bg-gray-100 dark:bg-gray-900 dark:text-white rounded-lg">
          ...
          <ul className="space-y-2">
            {/* Replace these with dynamic links or categories */}
            <li>
            ...
            <li>
              <Link href="/news-and-currentaffairs" className="text-indigo-500 hover:underline">
