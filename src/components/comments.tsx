  ...
  return (
    <div className={`${heebo.className} comment-section max-w-4xl mx-auto sm:p-6 p-3 py-6 border bg-white dark:bg-neutral-900 rounded-sm`}>
      ...
      <form onSubmit={handleSubmit} className="mt-6">
        ...
        <button type="submit" className="sm:w-[200px] w-full bg-gray-800 dark:bg-gray-500 text-white p-3 rounded-sm  hover:bg-blue-700 dark:hover:bg-blue-600 transition">
          Post Comment
        </button>
      </form>
    </div>
